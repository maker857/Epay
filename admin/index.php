...
?>
<?php
if(\lib\PasswordHasher::verifyAdmin('123456', $conf['admin_pwd'])){
...
}elseif(!\lib\PasswordHasher::isModern($conf['admin_pwd']) || strlen($conf['admin_pwd'])<6 || is_numeric($conf['admin_pwd']) && strlen($conf['admin_pwd'])<=10 || $conf['admin_pwd']===$conf['kfqq'] || $conf['admin_user']===$conf['admin_pwd']){
